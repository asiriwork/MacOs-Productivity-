...
open_new_window() {
	...
	declare -A app_menu_names=(["iTerm2"]="Shell" ["Orienter"]="Window")
	declare -A app_menu_indexes=(["iTerm2"]="1" ["Orienter"]="3")
...
# Usage example:
app_name="Time Tracking - Everhour"
threshold=5
max_attempts=9
spaces=(1 1 1 1 1)
